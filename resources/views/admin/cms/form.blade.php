...
<div class="row">
        ...
        <div class="bgcolor">
            <form method="POST" action="" accept-charset="UTF-8" enctype="multipart/form-data" role="form">
                ...
                <div class="row">
                    ...
                    <div class="form-group  col-md-6{{ $errors->has('template') ? ' has-error' : '' }}">
   ...
   <div class="form-group col-md-6{{ $errors->has('meta_keyword') ? ' has-error' : '' }}">
...
<div class="form-group col-md-12">
    ...
    <a href="{{ route('admin.cms.index') }}" class="btn btn-primary" title="Cancel">Cancel</a>
</div>
<br/><br/>
