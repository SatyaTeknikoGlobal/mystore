...
<script src='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js'></script>
  ...
  <!-- END : Head-->
<?php
$imgUrl10 = asset('public/assets/img/portrait/small/avatar-s-1.png');
if(!empty(Auth::guard('admin')->user()->image)){
    $imgUrl10 = url('/public/storage/user/thumb').'/'.Auth::guard('admin')->user()->image;
}
      ...
      <div class="container-fluid navbar-wrapper">
        <div class="navbar-header d-flex">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item nav-search" style="display: none;"><a class="nav-link nav-link-search" href="javascript:"><i class="ft-search font-medium-3"></i></a>
          ...
          <div class="collapse navbar-collapse d-block" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="dropdown nav-item mr-1"><a class="nav-link dropdown-toggle user-dropdown d-flex align-items-end" id="dropdownBasic2" href="javascript:;" data-toggle="dropdown">
                  <div class="user d-md-flex d-none mr-2"><span class="text-right">{{Auth::guard('admin')->user()->name}}</span><span class="text-right text-muted font-small-3">{{Auth::guard('admin')->user()->email}}</span></div><img class="avatar" src="{{$imgUrl10}}" alt="avatar" height="35" width="35"></a>
